  ...
  public partial class PaintForm : Form, IPaintSettings
  {
    ...
    private void ShowImage() {
      ...
      SetToolBarButtonsState(arrowBtn);
        ...
        private void fillStyleCombo_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void shapeStyleCombo_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void imageMnu_Click(object sender, EventArgs e)
        {
